...
returned by ``ResearchExecutor`` after delegating a ``ResearchPlan`` to the fbf.core.
...
from fbf.core.execution.pipeline.simulation import ExperimentRun, SimulationResult
