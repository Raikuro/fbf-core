...
from fbf.core.execution.errors import InvalidResearchPlanError, ResearchExecutionError
...
class TestResearchExecutorScopeGuards:
    def test_executor_module_does_not_import_cohort_generator(self) -> None:
        ...
        import fbf.core.execution.executor as executor_module
    ...
    def test_executor_does_not_call_cohort_generator_during_execute(self) -> None:
        ...
        import fbf.core.execution.executor as mod
