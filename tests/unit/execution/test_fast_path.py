...
class TestFastPathValidation:
    ...
    def test_validation_detects_divergence(
        ...
        from fbf.core.execution.strategies.fast_path import ClosedFormPath
        ...
        fp_mod = "fbf.core.execution.strategies.fast_path"
        monkeypatch.setattr(f"{fp_mod}.evaluate_path", doubled_evaluate)
